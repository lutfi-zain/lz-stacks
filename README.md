...
| [**lz-kairos-debugger**](./skills/lz-kairos-debugger/SKILL.md) | Enterprise-grade AWS ECS/CloudWatch root-cause investigation — adaptive RCA (5-Whys → Fishbone → Apollo RCA), digital forensics, change analysis, architectural tracing, timeline construction, and Mermaid sequence diagrams for Kairos (HIS/PAS/PAY) microservices. | `/skill:lz-kairos-debugger` |
